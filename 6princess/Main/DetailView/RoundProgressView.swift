...
struct RoundProgressView : View {
    ...
    var body: some View {
        ...
        let progress = 1 - (CGFloat(percent) / 20)
        ...
        return ZStack {
            ...
            .stroke(
                LinearGradient(
                    gradient: Gradient(colors: [Color(hex: 0x139460)]), startPoint: .topLeading, endPoint: .bottomTrailing),
...
struct RoundProgressView_Previews: PreviewProvider {
    static var previews: some View {
        RoundProgressView(percent: .constant(20))
